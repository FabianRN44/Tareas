...
Button(ventana,text="AC",bg=color_boton,width=ancho_boton,height=alto_boton,command=lambda:clear()).place(x=17,y=180)
Button(ventana,text="(",bg=color_boton,width=ancho_boton,height=alto_boton,command=lambda:btnClik("(")).place(x=107,y=180)
Button(ventana,text=")",bg=color_boton,width=ancho_boton,height=alto_boton,command=lambda:btnClik(")")).place(x=197,y=180)
...
Button(ventana,text="0",bg=color_boton,width=ancho_boton,height=alto_boton,command=lambda:btnClik(0)).place(x=17,y=420)
